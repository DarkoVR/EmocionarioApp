...
public class Music extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MediaPlayer lacrimosa = MediaPlayer.create(this,R.raw.lacrimosa);
        ...
        btMusica.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, Symphony5.class);
                intent.putExtras(b);
    ...
    public void onBackPressed() {
        AlertDialog.Builder dialogo2 = new AlertDialog.Builder(Music.this);
