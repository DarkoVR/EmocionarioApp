...
public class Symphony5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_symphony5);
        //CheckedBox
        ...
        final MediaPlayer symphony5 = MediaPlayer.create(this,R.raw.symphony5);
        ...
        btMusica.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, SpringWaltz.class);
                intent.putExtras(b);
    ...
    public void onBackPressed() {
        AlertDialog.Builder dialogo2 = new AlertDialog.Builder(Symphony5.this);
